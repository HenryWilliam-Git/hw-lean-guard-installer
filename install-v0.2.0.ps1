...
$packageName = 'HW-Lean-Guard-v0.2.0-Innessco.zip'
$packageRootName = 'HW-Lean-Guard-v0.2.0-Innessco'
$packageUri = 'https://github.com/HenryWilliam-Git/hw-lean-guard-installer/releases/download/v0.2.0/HW-Lean-Guard-v0.2.0-Innessco.zip'
$expectedPackageSha256 = 'badd21ca3746732a7d255fc063cd5f330ba08a376b2b614040c2521485ed64ff'
...
try {
  ...
  if ($actualPackageSha256 -cne $expectedPackageSha256) { throw 'Downloaded package SHA-256 does not match the pinned v0.2.0 artifact.' }
