...
$packageName = 'HW-Lean-Guard-v0.3.0-Innessco.zip'
$packageRootName = 'HW-Lean-Guard-v0.3.0-Innessco'
$packageUri = 'https://github.com/HenryWilliam-Git/hw-lean-guard-installer/releases/download/v0.3.0/HW-Lean-Guard-v0.3.0-Innessco.zip'
$expectedPackageSha256 = '9c675a353c7b50534f2d8a6b606f7e1a86ab91d9c7988e96451b506d38be7894'
...
try {
  ...
  if ($actualPackageSha256 -cne $expectedPackageSha256) { throw 'Downloaded package SHA-256 does not match the pinned v0.3.0 artifact.' }
